        ...
        <section className='bg-main-1' data-aos='zoom-y-out'>
          <div className='max-w-6xl mx-auto px-4 sm:px-6'>
            <div className='pt-32 pb-12 md:pt-40 md:pb-20'>
              ...
              <h2 className='h2 bg-clip-text text-white text-center pb-4'>Standard authentication with session</h2>
              <h3 className='h3 bg-clip-text text-white text-center pb-4'>Sign in</h3>
              <h4 className='h4 bg-clip-text text-white text-center pb-4'>
                or{' '}
                <span className='text-main-3 hover:text-main-4 cursor-pointer' onClick={() => navigate('/sign-up')}>
                  create an account
                </span>{' '}
