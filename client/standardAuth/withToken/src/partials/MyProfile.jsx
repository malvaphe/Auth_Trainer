    ...
    <section>
      <div className='max-w-6xl mx-auto px-4 sm:px-6 pt-6' data-aos='zoom-y-out'>
        <div className='max-w-3xl mx-auto pb-4 md:pb-4'>
          <div className='flex -mx-3 mb-1 pb-8 justify-center'>
            <div className='w-full md:w-1/2 px-3 text-center text-white'>
              <p>Your username is {user.username}</p>
              <p>{user.admin ? "You're an admin" : "You're not an admin"}</p>
            </div>
          </div>
          <div className='flex -mx-3 mb-1 pb-8 justify-center'>
